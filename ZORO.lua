...
send(msg.chat_id_, msg.id_, "๛ لا يمكنك حظر المبرمج السورس  \n")
return false 
end
...
if text == (database:get(bot_id.."ZORBAIR:Name:Bot") or "جوكر") then
Namebot = (database:get(bot_id.."ZORBAIR:Name:Bot") or "جوكر")
local namebot = {
'๛ يوه '..Namebot..' زهق منك😒',
'๛ نعم ياعيون '..Namebot..' 😻💓',
'๛ عايز اي من '..Namebot..' 🙄💛',
...
local Text_Dev = database:get(bot_id..'ZORBAIR:Text_Dev')
if Text_Dev then 
...
local Name_Bot = (database:get(bot_id.."ZORBAIR:Name:Bot") or "جوكر")
