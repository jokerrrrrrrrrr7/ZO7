...
--]]
database = dofile("./ZOR/redis.lua").connect("127.0.0.1", 6379)
serpent = dofile("./ZOR/serpent.lua")
JSON    = dofile("./ZOR/dkjson.lua")
json    = dofile("./ZOR/JSON.lua")
URL     = dofile("./ZOR/url.lua")
http    = require("socket.http")
https   = require("ssl.https")
sudos   = dofile("sudo.lua")
bot_id  = token:match("(%d+)")  
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1003237899,1765160742}
print("\27[34m"..[[

>> Best Source in Telegram
>> Features ZORBAIR and powerful
...
--------------------
io.popen("mkdir ZORBAIR_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls ZORBAIR_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
function DevBot(msg) 
local hash = database:sismember(bot_id.."ZORBAIR:Sudo:User", msg.sender_user_id_) 
if hash or DevZORBAIR(msg) or DevBOYKAW(msg) then  
return true  
else  
return false  
end  
...
if hash or DevZORBAIR(msg) then  
return true  
else  
return false  
end  
...
local hash = database:sismember(bot_id.."ZORBAIR:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevZORBAIR(msg) or DevBOYKAW(msg)  or DevBot(msg) then 
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."ZORBAIR:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevZORBAIR(msg) or DevBOYKAW(msg) or DevBot(msg) or BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
function Owner(msg)
local hash = database:sismember(bot_id.."ZORBAIR:Manager"..msg.chat_id_,msg.sender_user_id_)    
if hash or DevZORBAIR(msg) or DevBOYKAW(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_,msg.sender_user_id_)    
if hash or DevZORBAIR(msg) or DevBOYKAW(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
function Vips(msg)
local hash = database:sismember(bot_id.."ZORBAIR:Special:User"..msg.chat_id_,msg.sender_user_id_) 
if hash or DevZORBAIR(msg) or DevBOYKAW(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
var = true  
elseif database:sismember(bot_id.."ZORBAIR:Sudo:User", user_id) then
var = true  
elseif database:sismember(bot_id.."ZORBAIR:Basic:Constructor"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."ZORBAIR:Constructor"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."ZORBAIR:Manager"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."ZORBAIR:Mod:User"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."ZORBAIR:Special:User"..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
elseif tonumber(user_id) == tonumber(1003237899) then  
var = "مبرمج السورس "
elseif DevZORBAIRe(user_id) == true then
var = "المطور الاساسي"  
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then 
var = "المطور الاساسي²"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
elseif database:sismember(bot_id.."ZORBAIR:Sudo:User", user_id) then
var = database:get(bot_id.."ZORBAIR:Sudo:Rd"..chat_id) or "المطور"  
elseif database:sismember(bot_id.."ZORBAIR:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."ZORBAIR:BasicConstructor:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."ZORBAIR:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."ZORBAIR:Constructor:Rd"..chat_id) or "المنشئ"  
elseif database:sismember(bot_id.."ZORBAIR:Manager"..chat_id, user_id) then
var = database:get(bot_id.."ZORBAIR:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."ZORBAIR:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."ZORBAIR:Mod:Rd"..chat_id) or "الادمن"  
elseif database:sismember(bot_id.."ZORBAIR:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."ZORBAIR:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."ZORBAIR:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
function ChekAdd(chat_id)
if database:sismember(bot_id.."ZORBAIR:Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if database:sismember(bot_id.."ZORBAIR:Muted:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."ZORBAIR:Ban:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."ZORBAIR:GBan:User",User_id) then
Var = true
else
Var = false
end
...
for ZORBAIR in string.gmatch(data.first_name_, "[^%s]+") do
data.first_name_ = ZORBAIR
end
...
local respbahjat = {} 
local options = { url = url, sink = ltn12.sink.table(respbahjat), redirect = true } 
local response = nil 
...
file:write(table.concat(respbahjat)) 
file:close() 
...
database:sadd(bot_id..'ZORBAIR:Chek:Groups',idg) 
database:set(bot_id.."ZORBAIR:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'ZORBAIR:'..lock..idg,"del")    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd(bot_id.."ZORBAIR:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."ZORBAIR:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."ZORBAIR:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."ZORBAIR:Basic:Constructor"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
database:set(bot_id.."ZORBAIR:Private:Group:Link"..idg,v.linkgroup)   
end;end;end
send(chat,msg.id_,"๛ تم رفع الملف بنجاح وتفعيل المجموعات\nᯓ ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")   
end
...
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
...
function ZORBAIR_Files(msg)
for v in io.popen('ls ZORBAIR_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("ZORBAIR_Files/"..v)
if plugin.ZORBAIR and msg then
pre_msg = plugin.ZORBAIR(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function ZORBAIR_Started_Bot(msg,data) -- بداية العمل
if msg then
...
database:incr(bot_id..'ZORBAIR:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'ZORBAIR:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
end
if database:get(bot_id.."ZORBAIR:ZORBAIR:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ๛" then   
send(msg.chat_id_, msg.id_,"๛ تم الغاء الاذاعه") 
database:del(bot_id.."ZORBAIR:ZORBAIR:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."ZORBAIR:Chek:Groups") 
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
database:set(bot_id..'ZORBAIR:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
database:set(bot_id..'ZORBAIR:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'ZORBAIR:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
database:set(bot_id..'ZORBAIR:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."ZORBAIR:flooding:settings:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."ZORBAIR:flooding:settings:"..msg.chat_id_,"flood") or "nil"
Num_Msg_Max = database:hget(bot_id.."ZORBAIR:flooding:settings:"..msg.chat_id_,"floodmax") or 5
Time_Spam = database:hget(bot_id.."ZORBAIR:flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id.."ZORBAIR:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."ZORBAIR:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."ZORBAIR:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."ZORBAIR:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."ZORBAIR:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."ZORBAIR:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."ZORBAIR:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."ZORBAIR:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."ZORBAIR:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."ZORBAIR:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."ZORBAIR:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."ZORBAIR:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if database:get(bot_id.."ZORBAIR:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if database:get(bot_id.."ZORBAIR:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."ZORBAIR:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."ZORBAIR:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."ZORBAIR:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."ZORBAIR:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."ZORBAIR:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."ZORBAIR:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."ZORBAIR:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."ZORBAIR:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."ZORBAIR:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."ZORBAIR:Lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."ZORBAIR:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."ZORBAIR:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."ZORBAIR:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."ZORBAIR:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."ZORBAIR:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."ZORBAIR:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."ZORBAIR:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if database:get(bot_id.."ZORBAIR:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."ZORBAIR:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."ZORBAIR:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if database:get(bot_id.."ZORBAIR:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."ZORBAIR:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
--------------------------------------------------------------------------------------------------------------
local status_welcome = database:get(bot_id.."ZORBAIR:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."ZORBAIR:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."ZORBAIR:Get:Welcome:Group"..msg.chat_id_)  
...
database:set(bot_id.."ZORBAIR:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."ZORBAIR:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."ZORBAIR:lockpin"..msg.chat_id_) then
...
if database:get(bot_id.."ZORBAIR:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
database:del(bot_id.."ZORBAIR:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."ZORBAIR:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"๛ تم الغاء وضع الوصف") 
database:del(bot_id.."ZORBAIR:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."ZORBAIR:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."ZORBAIR:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"๛ تم الغاء حفظ الترحيب") 
database:del(bot_id.."ZORBAIR:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."ZORBAIR:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id.."ZORBAIR:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"๛ تم حفظ ترحيب المجموعه")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."ZORBAIR:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"๛ تم الغاء حفظ الرابط")       
database:del(bot_id.."ZORBAIR:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
if text and text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/joinchat/%S+)") then     
local Link = text:match("(https://telegram.me/joinchat/%S+)") or text:match("(https://t.me/joinchat/%S+)")   
database:set(bot_id.."ZORBAIR:Private:Group:Link"..msg.chat_id_,Link)
...
if database:get(bot_id.."ZORBAIR:ZORBAIR:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ๛" then   
send(msg.chat_id_, msg.id_,"๛ تم الغاء الاذاعه للخاص") 
database:del(bot_id.."ZORBAIR:ZORBAIR:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id..'ZORBAIR:UsersBot')  
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
end
...
if database:get(bot_id.."ZORBAIR:ZORBAIR:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ๛" then   
send(msg.chat_id_, msg.id_,"๛ تم الغاء الاذاعه") 
database:del(bot_id.."ZORBAIR:ZORBAIR:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."ZORBAIR:Chek:Groups") 
if msg.content_.text_ then
...
if database:get(bot_id.."ZORBAIR:ZORBAIR:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ๛" then   
send(msg.chat_id_, msg.id_,"๛ تم الغاء الاذاعه") 
database:del(bot_id.."ZORBAIR:ZORBAIR:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
if database:get(bot_id.."ZORBAIR:ZORBAIR:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ๛" then   
send(msg.chat_id_, msg.id_,"๛ تم الغاء الاذاعه") 
database:del(bot_id.."ZORBAIR:ZORBAIR:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."ZORBAIR:UsersBot")   
...
local ZORBAIR_Msg = database:get(bot_id.."ZORBAIR:Add:Filter:Rp2"..text..msg.chat_id_)   
if ZORBAIR_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","๛ "..ZORBAIR_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
if database:get(bot_id.."ZORBAIR:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ๛" then   
send(msg.chat_id_, msg.id_,"๛ تم الغاء حفظ اسم البوت") 
database:del(bot_id.."ZORBAIR:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."ZORBAIR:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."ZORBAIR:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "๛ تم حفظ اسم البوت")  
return false
end 
if text and database:get(bot_id.."ZORBAIR:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."ZORBAIR:Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"๛ ارسل الامر الجديد")  
database:del(bot_id.."ZORBAIR:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."ZORBAIR:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."ZORBAIR:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."ZORBAIR:Set:Cmd:Group:New"..msg.chat_id_)
database:set(bot_id.."ZORBAIR:Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."ZORBAIR:List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"๛ تم حفظ الامر")  
database:del(bot_id.."ZORBAIR:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
database:set(bot_id.."ZORBAIR:Lock:text"..msg.chat_id_,true) 
...
database:set(bot_id.."ZORBAIR:Lock:AddMempar"..msg.chat_id_,"kick")  
...
database:set(bot_id.."ZORBAIR:Lock:Join"..msg.chat_id_,"kick")  
...
database:set(bot_id.."ZORBAIR:Lock:Bot:kick"..msg.chat_id_,"del")  
...
database:set(bot_id.."ZORBAIR:Lock:Bot:kick"..msg.chat_id_,"kick")  
...
database:set(bot_id.."ZORBAIR:Lock:tagservr"..msg.chat_id_,true)  
...
database:set(bot_id.."ZORBAIR:lockpin"..msg.chat_id_, true) 
database:sadd(bot_id.."ZORBAIR:Lock:pin",msg.chat_id_) 
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  database:set(bot_id.."ZORBAIR:Pin:Id:Msg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
database:set(bot_id.."ZORBAIR:Lock:edit"..msg.chat_id_,true) 
...
database:set(bot_id.."ZORBAIR:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'ZORBAIR:'..lock..msg.chat_id_,"del")    
end
...
database:del(bot_id.."ZORBAIR:Lock:AddMempar"..msg.chat_id_)  
...
database:del(bot_id.."ZORBAIR:Lock:text"..msg.chat_id_)  
...
database:del(bot_id.."ZORBAIR:Lock:Join"..msg.chat_id_)  
...
database:del(bot_id.."ZORBAIR:Lock:Bot:kick"..msg.chat_id_)  
...
database:del(bot_id.."ZORBAIR:Lock:tagservr"..msg.chat_id_)  
...
database:del(bot_id.."ZORBAIR:lockpin"..msg.chat_id_)  
database:srem(bot_id.."ZORBAIR:Lock:pin",msg.chat_id_)
...
database:del(bot_id.."ZORBAIR:Lock:edit"..msg.chat_id_) 
...
database:del(bot_id.."ZORBAIR:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:del(bot_id..'ZORBAIR:'..lock..msg.chat_id_)    
end
...
if text == ("المطورين") and DevZORBAIR(msg) then
local list = database:smembers(bot_id.."ZORBAIR:Sudo:User")
t = "\nᯓ قائمة مطورين البوت \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."ZORBAIR:User:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
local list = database:smembers(bot_id.."ZORBAIR:Basic:Constructor"..msg.chat_id_)
t = "\nᯓ قائمة المنشئين الاساسين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."ZORBAIR:User:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
local list = database:smembers(bot_id.."ZORBAIR:Constructor"..msg.chat_id_)
t = "\nᯓ قائمة المنشئين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."ZORBAIR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."ZORBAIR:Manager"..msg.chat_id_)
t = "\nᯓ قائمة المدراء \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."ZORBAIR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_)
t = "\nᯓ قائمة الادمنيه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."ZORBAIR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."ZORBAIR:Special:User"..msg.chat_id_)
t = "\nᯓ قائمة مميزين المجموعه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."ZORBAIR:User:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
local list = database:smembers(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_)
t = "\nᯓ قائمة المكتومين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."ZORBAIR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."ZORBAIR:Ban:User"..msg.chat_id_)
t = "\nᯓ قائمة محظورين المجموعه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."ZORBAIR:User:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
function Function_ZORBAIR(extra, result, success)
if result.sender_user_id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, "๛ لا يمكنك حظر المطور الاساسي \n")
return false
end
if result.sender_user_id_ == tonumber(1765160742) then
send(msg.chat_id_, msg.id_, "๛ لا يمكنك حظر المبرمج الجوكر \n")
return false 
end
if result.sender_user_id_ == tonumber(1003237899) then
...
database:sadd(bot_id.."ZORBAIR:GBan:User", result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","๛ تم حظره عام من المجموعات")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ZORBAIR, nil)
return false
end
...
if result.id_ == tonumber(1003237899) then
send(msg.chat_id_, msg.id_, "๛ لا يمكنك حظر مبرمج السورس  \n")
return false 
end
database:sadd(bot_id.."ZORBAIR:GBan:User", result.id_)
Reply_Status(msg,result.id_,"reply","๛ تم حظره عام من المجموعات")  
else
send(msg.chat_id_, msg.id_,"๛ لا يوجد حساب بهاذا المعرف")
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_ZORBAIR, nil)
return false
end
...
if userid == tonumber(1765160742) then
send(msg.chat_id_, msg.id_, "๛ لا يمكنك حظر المبرمج الجوكر \n")
return false 
end
if userid == tonumber(1003237899) then
send(msg.chat_id_, msg.id_, "๛ لا يمكنك حظر مبرمج السورس  \n")
return false 
end
...
database:sadd(bot_id.."ZORBAIR:GBan:User", userid)
...
function Function_ZORBAIR(extra, result, success)
database:srem(bot_id.."ZORBAIR:GBan:User", result.sender_user_id_)
...
database:srem(bot_id.."ZORBAIR:GBan:User", result.id_)
else
send(msg.chat_id_, msg.id_,"๛ لا يوجد حساب بهاذا المعرف")
end
end
...
database:srem(bot_id.."ZORBAIR:GBan:User", userid)
...
function Function_ZORBAIR(extra, result, success)
database:sadd(bot_id.."ZORBAIR:Sudo:User", result.sender_user_id_)
...
database:sadd(bot_id.."ZORBAIR:Sudo:User", result.id_)
...
database:sadd(bot_id.."ZORBAIR:Sudo:User", userid)
...
function Function_ZORBAIR(extra, result, success)
database:srem(bot_id.."ZORBAIR:Sudo:User", result.sender_user_id_)
...
function Function_ZORBAIR(extra, result, success)
if result.id_ then
database:srem(bot_id.."ZORBAIR:Sudo:User", result.id_)
...
database:srem(bot_id.."ZORBAIR:Sudo:User", userid)
...
function Function_ZORBAIR(extra, result, success)
database:sadd(bot_id.."ZORBAIR:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."ZORBAIR:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."ZORBAIR:Basic:Constructor"..msg.chat_id_, userid)
...
if da.status_.ID == "ChatMemberStatusCreator" then
function Function_ZORBAIR(extra, result, success)
database:srem(bot_id.."ZORBAIR:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
function Function_ZORBAIR(extra, result, success)
if result.id_ then
database:srem(bot_id.."ZORBAIR:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."ZORBAIR:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_ZORBAIR(extra, result, success)
database:sadd(bot_id.."ZORBAIR:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."ZORBAIR:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."ZORBAIR:Constructor"..msg.chat_id_, userid)
...
function Function_ZORBAIR(extra, result, success)
database:srem(bot_id.."ZORBAIR:Constructor"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","๛ تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ZORBAIR, nil)
end
...
function Function_ZORBAIR(extra, result, success)
if result.id_ then
database:srem(bot_id.."ZORBAIR:Constructor"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","๛ تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"๛ لا يوجد حساب بهاذا المعرف")
end
...
database:srem(bot_id.."ZORBAIR:Constructor"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","๛ تم تنزيله من المنشئين")  
end

if text == ("رفع مدير") and tonumber(msg.reply_to_message_id_) ~= 0 and Constructor(msg) then 
function Function_ZORBAIR(extra, result, success)
database:sadd(bot_id.."ZORBAIR:Manager"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."ZORBAIR:Manager"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."ZORBAIR:Manager"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","๛ تم ترقيته مدير المجموعه")  
return false
end  
if text == ("تنزيل مدير") and tonumber(msg.reply_to_message_id_) ~= 0 and Constructor(msg) then 
function Function_ZORBAIR(extra, result, success)
database:srem(bot_id.."ZORBAIR:Manager"..msg.chat_id_, result.sender_user_id_)
...
function Function_ZORBAIR(extra, result, success)
if result.id_ then
database:srem(bot_id.."ZORBAIR:Manager"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."ZORBAIR:Manager"..msg.chat_id_, userid)
...
function Function_ZORBAIR(extra, result, success)
database:sadd(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","๛ تم ترقيته ادمن للمجموعه")  
return false
end
if text == ("تنزيل ادمن") and tonumber(msg.reply_to_message_id_) ~= 0 and Owner(msg) then 
function Function_ZORBAIR(extra, result, success)
database:srem(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_ZORBAIR(extra, result, success)
if result.id_ then
database:srem(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_, userid)
...
function Function_ZORBAIR(extra, result, success)
database:sadd(bot_id.."ZORBAIR:Special:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."ZORBAIR:Special:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."ZORBAIR:Special:User"..msg.chat_id_, userid)
...
function Function_ZORBAIR(extra, result, success)
database:srem(bot_id.."ZORBAIR:Special:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_ZORBAIR(extra, result, success)
if result.id_ then
database:srem(bot_id.."ZORBAIR:Special:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."ZORBAIR:Special:User"..msg.chat_id_, userid)
...
if database:sismember(bot_id.."ZORBAIR:Coomds"..msg.chat_id_,RTPA) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local ZORBAIRrt = database:get(bot_id.."ZORBAIR:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if ZORBAIRrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\nᯓ العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\nᯓ تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."ZORBAIR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."ZORBAIR:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif ZORBAIRrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\nᯓ العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\nᯓ تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."ZORBAIR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif ZORBAIRrt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"\nᯓ العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\nᯓ تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."ZORBAIR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."ZORBAIR:Manager"..msg.chat_id_,result.sender_user_id_)  
elseif ZORBAIRrt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\nᯓ العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\nᯓ تم رفعه "..RTPA.." هنا\n")   
end
end,nil)   
end   
...
local ZORBAIRrt = database:get(bot_id.."ZORBAIR:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if ZORBAIRrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\nᯓ العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\nᯓ تم تنزيله من "..RTPA.." هنا\n")   
database:srem(bot_id.."ZORBAIR:Special:User"..msg.chat_id_,result.sender_user_id_)  
database:del(bot_id.."ZORBAIR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif ZORBAIRrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\nᯓ العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\nᯓ تم تنزيله من "..RTPA.." هنا\n")   
database:srem(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_,result.sender_user_id_) 
database:del(bot_id.."ZORBAIR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
...
if database:sismember(bot_id.."ZORBAIR:Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local ZORBAIRrt = database:get(bot_id.."ZORBAIR:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if ZORBAIRrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\nᯓ العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\nᯓ تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."ZORBAIR:Special:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."ZORBAIR:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif ZORBAIRrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\nᯓ العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\nᯓ تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."ZORBAIR:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
...
local ZORBAIRrt = database:get(bot_id.."ZORBAIR:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if ZORBAIRrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\nᯓ العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\nᯓ تم تنريله من "..text1[2].." هنا")   
database:srem(bot_id.."ZORBAIR:Special:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."ZORBAIR:Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif ZORBAIRrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\nᯓ العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\nᯓ تم تنريله من "..text1[2].." هنا")   
database:srem(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."ZORBAIR:Comd:New:rt:User:"..msg.chat_id_..result.id_)
...
send(msg.chat_id_, msg.id_, "\nᯓ عذرا لا تستطيع طرد او حظر او كتم او تقييد ( "..Get_Rank(result.sender_user_id_,msg.chat_id_).." )")
else
...
database:sadd(bot_id.."ZORBAIR:Ban:User"..msg.chat_id_, result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
...
send(msg.chat_id_, msg.id_, "\nᯓ عذرا لا تستطيع طرد او حظر او كتم او تقييد ( "..Get_Rank(result.id_,msg.chat_id_).." )")
else
...
database:sadd(bot_id.."ZORBAIR:Ban:User"..msg.chat_id_, result.id_)
...
send(msg.chat_id_, msg.id_, "\nᯓ عذرا لا تستطيع طرد او حظر او كتم او تقييد ( "..Get_Rank(userid,msg.chat_id_).." )")
else
...
database:sadd(bot_id.."ZORBAIR:Ban:User"..msg.chat_id_, userid)
...
database:srem(bot_id.."ZORBAIR:Ban:User"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."ZORBAIR:Ban:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."ZORBAIR:Ban:User"..msg.chat_id_, userid)
...
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_, userid)
...
function Function_ZORBAIR(extra, result, success)
database:srem(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_ZORBAIR(extra, result, success)
if result.id_ then
database:srem(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_, userid)
...
tdcli_function ({ID = "SearchPublicChat",username_ = TextEnd[4]}, Function_ZORBAIR, nil)
return false
end
------------------------------------------------------------------------
...
if database:sismember(bot_id.."ZORBAIR:Lock:pin",msg.chat_id_) and not Constructor(msg) then
...
database:set(bot_id.."ZORBAIR:Pin:Id:Msg"..msg.chat_id_,msg.reply_to_message_id_)
...
database:del(bot_id.."ZORBAIR:Pin:Id:Msg"..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"๛ انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"๛ ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
...
database:hset(bot_id.."ZORBAIR:flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."ZORBAIR:flooding:settings:"..msg.chat_id_ ,"floodtime" ,Num) 
send(msg.chat_id_, msg.id_,"๛ تم وضع زمن التكرار ("..Num..")") 
end
if text == "ضع رابط" or text == "وضع رابط" then
if msg.reply_to_message_id_ == 0  and Addictive(msg) then  
send(msg.chat_id_,msg.id_,"๛ ارسل رابط المجموعه او رابط قناة المجموعه")
database:setex(bot_id.."ZORBAIR:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_,120,true) 
return false
end
end
if text == "تفعيل جلب الرابط" or text == 'تفعيل الرابط' then
if Addictive(msg) then  
database:set(bot_id.."ZORBAIR:Link_Group"..msg.chat_id_,true) 
...
if Addictive(msg) then  
database:del(bot_id.."ZORBAIR:Link_Group"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"๛ تم تعطيل جلب رابط المجموعه") 
return false end
end
if text == "الرابط" then 
local status_Link = database:get(bot_id.."ZORBAIR:Link_Group"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_,"๛ جلب الرابط معطل") 
return false  
end
local link = database:get(bot_id.."ZORBAIR:Private:Group:Link"..msg.chat_id_)            
if link then                              
...
database:del(bot_id.."ZORBAIR:Private:Group:Link"..msg.chat_id_) 
return false      
end
return false  
end
...
if Addictive(msg) then
database:setex(bot_id.."ZORBAIR:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if Addictive(msg) then
database:setex(bot_id.."ZORBAIR:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
t  = "๛ ارسل لي الترحيب الان"
tt = "\nᯓ تستطيع اضافة مايلي !\nᯓ دالة عرض الاسم »{`name`}\nᯓ دالة عرض المعرف »{`user`}"
send(msg.chat_id_, msg.id_,t..tt) 
end
return false  
end
if text == "الترحيب" and Addictive(msg) then 
if database:get(bot_id.."ZORBAIR:Get:Welcome:Group"..msg.chat_id_)   then 
Welcome = database:get(bot_id.."ZORBAIR:Get:Welcome:Group"..msg.chat_id_)  
else 
...
database:set(bot_id.."ZORBAIR:Chek:Welcome"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,"๛ تم تفعيل ترحيب المجموعه") 
return false  
end
if text == "تعطيل الترحيب" and Addictive(msg) then  
database:del(bot_id.."ZORBAIR:Chek:Welcome"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"๛ تم تعطيل ترحيب المجموعه") 
return false  
end
if text == "مسح الترحيب" or text == "حذف الترحيب" then 
if Addictive(msg) then
database:del(bot_id.."ZORBAIR:Get:Welcome:Group"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"๛ تم ازالة ترحيب المجموعه") 
end
return false  
end
if text == 'تفعيل all' and DevZORBAIR(msg) then   
...
if text == 'تعطيل all' and DevZORBAIR(msg) then  
...
local list = database:smembers(bot_id.."ZORBAIR:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ZORBAIR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ZORBAIR:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ZORBAIR:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\nᯓ قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local ZORBAIR_Msg = database:get(bot_id.."ZORBAIR:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..ZORBAIR_Msg.."}\n"    
end  
if #list == 0 then  
...
database:set(bot_id.."ZORBAIR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ZORBAIR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"๛ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."ZORBAIR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ZORBAIR:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ZORBAIR:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ZORBAIR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"๛ تم منع الكلمه مع التحذير")  
database:del(bot_id.."ZORBAIR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ZORBAIR:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ZORBAIR:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ZORBAIR:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Addictive(msg) then    
send(msg.chat_id_, msg.id_,"๛ ارسل الكلمه الان")  
database:set(bot_id.."ZORBAIR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ZORBAIR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ZORBAIR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ZORBAIR:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ZORBAIR:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local t = "๛ عدد البوتات هنا >> {"..c.."}\nᯓ عدد البوتات التي هي ادمن >> {"..x.."}\nᯓ تم طرد >> {"..(c - x).."} من البوتات"
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
if #admins == i then 
local a = "\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \nᯓ عدد البوتات التي هنا >> {"..n.."} بوت\n"
local f = "๛ عدد البوتات التي هي ادمن >> {"..t.."}\nᯓ ملاحضه علامة ال (✯) تعني ان البوت ادمن \nᯓ"
...
----------------------------------
if database:get(bot_id.."ZORBAIR:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "๛ تم الغاء حفظ القوانين") 
database:del(bot_id.."ZORBAIR:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."ZORBAIR:Set:Rules:Group" .. msg.chat_id_,text) 
...
if Addictive(msg) then
database:setex(bot_id.."ZORBAIR:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:del(bot_id.."ZORBAIR:Set:Rules:Group"..msg.chat_id_) 
end
end
if text == "القوانين" then 
local Set_Rules = database:get(bot_id.."ZORBAIR:Set:Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
local list = database:smembers(bot_id.."ZORBAIR:List:Cmd:Group:New"..msg.chat_id_.."")
t = "๛ قائمه الاوامر المضافه  \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
Cmds = database:get(bot_id.."ZORBAIR:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..""..k.."- ("..v..") ~ {"..Cmds.."}\n"
else
t = t..""..k.."- ("..v..") \n"
...
local list = database:smembers(bot_id.."ZORBAIR:List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."ZORBAIR:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
database:del(bot_id.."ZORBAIR:List:Cmd:Group:New"..msg.chat_id_)
end
send(msg.chat_id_, msg.id_,"๛ تم مسح جميع الاوامر التي تم اضافتها")  
end
end
if text == "اضف امر" and Constructor(msg) then
database:set(bot_id.."ZORBAIR:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
send(msg.chat_id_, msg.id_,"๛ الان ارسل لي الامر القديم ..")  
return false
end
if text == "حذف امر" or text == "مسح امر" then 
if Constructor(msg) then
database:set(bot_id.."ZORBAIR:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local list = database:smembers(bot_id.."ZORBAIR:Coomds"..msg.chat_id_)
if #list == 0 then
send(msg.chat_id_, msg.id_,"๛ لا توجد صلاحيات مضافه")
return false
end
t = "\nᯓ قائمة الصلاحيات المضافه \n━━━━━━━━━━━━━\n"
for k,v in pairs(list) do
var = database:get(bot_id.."ZORBAIR:Comd:New:rt:bot:"..v..msg.chat_id_)
if var then
t = t..""..k.."- "..v.." ~ ("..var..")\n"
else
t = t..""..k.."- "..v.."\n"
...
local list = database:smembers(bot_id.."ZORBAIR:Coomds"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."ZORBAIR:Comd:New:rt:bot:"..v..msg.chat_id_)
database:del(bot_id.."ZORBAIR:Coomds"..msg.chat_id_)
end
send(msg.chat_id_, msg.id_,"๛ تم مسح الصلاحيات")
end
if text and text:match("^اضف صلاحيه (.*)$") and Addictive(msg) then 
ComdNew = text:match("^اضف صلاحيه (.*)$")
database:set(bot_id.."ZORBAIR:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
database:sadd(bot_id.."ZORBAIR:Coomds"..msg.chat_id_,ComdNew)  
database:setex(bot_id.."ZORBAIR:Comd:New"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
send(msg.chat_id_, msg.id_, "๛ ارسل نوع الصلاحيه ๛\nᯓ (عضو ~ مميز  ~ ادمن  ~ مدير )") 
end
if text and text:match("^مسح صلاحيه (.*)$") and Addictive(msg) or text and text:match("^حذف صلاحيه (.*)$") and Addictive(msg) then 
ComdNew = text:match("^مسح صلاحيه (.*)$") or text:match("^حذف صلاحيه (.*)$")
database:del(bot_id.."ZORBAIR:Comd:New:rt:bot:"..ComdNew..msg.chat_id_)
send(msg.chat_id_, msg.id_, "๛ تم مسح الصلاحيه ") 
end
if database:get(bot_id.."ZORBAIR:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,"๛ تم الغاء الامر ") 
database:del(bot_id.."ZORBAIR:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
if not Constructor(msg) then
send(msg.chat_id_, msg.id_"๛ ارسل نوع الصلاحيه مره اخر\nᯓ تستطيع اضافة صلاحيه (عضو ~ مميز  ~ ادمن )") 
return false
end
end
if text == "ادمن" then
if not Owner(msg) then 
send(msg.chat_id_, msg.id_"๛ ارسل نوع الصلاحيه مره اخر\nᯓ تستطيع اضافة صلاحيه ( عضو ~ مميز )") 
return false
end
end
if text == "مميز" then
if not Addictive(msg) then
send(msg.chat_id_, msg.id_"๛ ارسل نوع الصلاحيه مره اخر\nᯓ تستطيع اضافة صلاحيه ( عضو )") 
return false
end
end
if text == "مدير" or text == "ادمن" or text == "مميز" or text == "عضو" then
local textn = database:get(bot_id.."ZORBAIR:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
database:set(bot_id.."ZORBAIR:Comd:New:rt:bot:"..textn..msg.chat_id_,text)
...
database:set(bot_id.."ZORBAIR:Sudo:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"๛ تم تغير رد المطور الى » "..Teext)
end
if text and text:match("^تغير رد المنشئ الاساسي (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ الاساسي (.*)$") 
database:set(bot_id.."ZORBAIR:BasicConstructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"๛ تم تغير رد المنشئ الاساسي الى » "..Teext)
end
if text and text:match("^تغير رد المنشئ (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ (.*)$") 
database:set(bot_id.."ZORBAIR:Constructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"๛ تم تغير رد المنشئ الى » "..Teext)
end
if text and text:match("^تغير رد المدير (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المدير (.*)$") 
database:set(bot_id.."ZORBAIR:Manager:Rd"..msg.chat_id_,Teext) 
send(msg.chat_id_, msg.id_,"๛ تم تغير رد المدير الى » "..Teext)
end
if text and text:match("^تغير رد الادمن (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد الادمن (.*)$") 
database:set(bot_id.."ZORBAIR:Mod:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"๛ تم تغير رد الادمن الى » "..Teext)
end
if text and text:match("^تغير رد المميز (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المميز (.*)$") 
database:set(bot_id.."ZORBAIR:Special:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"๛ تم تغير رد المميز الى » "..Teext)
end
if text and text:match("^تغير رد العضو (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد العضو (.*)$") 
database:set(bot_id.."ZORBAIR:Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"๛ تم تغير رد العضو الى » "..Teext)
end


if text == ("مسح الردود") and Owner(msg) then
local list = database:smembers(bot_id.."ZORBAIR:List:Manager"..msg.chat_id_.."")
for k,v in pairs(list) do
database:del(bot_id.."ZORBAIR:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
database:del(bot_id.."ZORBAIR:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
database:del(bot_id.."ZORBAIR:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."ZORBAIR:Add:Rd:Manager:Text"..v..msg.chat_id_)   
database:del(bot_id.."ZORBAIR:Add:Rd:Manager:Photo"..v..msg.chat_id_)
database:del(bot_id.."ZORBAIR:Add:Rd:Manager:Video"..v..msg.chat_id_)
database:del(bot_id.."ZORBAIR:Add:Rd:Manager:File"..v..msg.chat_id_)
database:del(bot_id.."ZORBAIR:Add:Rd:Manager:Audio"..v..msg.chat_id_)
database:del(bot_id.."ZORBAIR:List:Manager"..msg.chat_id_)
end
...
text = "๛ قائمه الردود \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if database:get(bot_id.."ZORBAIR:Add:Rd:Manager:Gif"..v..msg.chat_id_) then
db = "متحركه ๛"
elseif database:get(bot_id.."ZORBAIR:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمه ๛"
elseif database:get(bot_id.."ZORBAIR:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ملصق ๛"
elseif database:get(bot_id.."ZORBAIR:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رساله ๛"
elseif database:get(bot_id.."ZORBAIR:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صوره ๛"
elseif database:get(bot_id.."ZORBAIR:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيديو ๛"
elseif database:get(bot_id.."ZORBAIR:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف ๛"
elseif database:get(bot_id.."ZORBAIR:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنيه ๛"
end
text = text..""..k..">> ("..v..") » {"..db.."}\n"
end
...
local test = database:get(bot_id.."ZORBAIR:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."ZORBAIR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."ZORBAIR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."ZORBAIR:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."ZORBAIR:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."ZORBAIR:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."ZORBAIR:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."ZORBAIR:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."ZORBAIR:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."ZORBAIR:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."ZORBAIR:Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
end
...
database:set(bot_id.."ZORBAIR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد" and Owner(msg) then
send(msg.chat_id_, msg.id_,"๛ ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."ZORBAIR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."ZORBAIR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '๛ الان ارسل الرد الذي تريد اضافته \nᯓ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\nᯓ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."ZORBAIR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
database:set(bot_id.."ZORBAIR:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:del(bot_id.."ZORBAIR:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."ZORBAIR:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."ZORBAIR:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."ZORBAIR:Add:Rd:Manager:Text"..text..msg.chat_id_)   
database:del(bot_id.."ZORBAIR:Add:Rd:Manager:Photo"..text..msg.chat_id_)
database:del(bot_id.."ZORBAIR:Add:Rd:Manager:Video"..text..msg.chat_id_)
database:del(bot_id.."ZORBAIR:Add:Rd:Manager:File"..text..msg.chat_id_)
database:del(bot_id.."ZORBAIR:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:sadd(bot_id.."ZORBAIR:List:Manager"..msg.chat_id_.."", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."ZORBAIR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
...
database:del(bot_id.."ZORBAIR:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:del(bot_id.."ZORBAIR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."ZORBAIR:List:Manager"..msg.chat_id_.."", text)
return false
end
end
if text and not database:get(bot_id.."ZORBAIR:Reply:Manager"..msg.chat_id_) then
if not database:sismember(bot_id..'ZORBAIR:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."ZORBAIR:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = database:get(bot_id.."ZORBAIR:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = database:get(bot_id.."ZORBAIR:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = database:get(bot_id.."ZORBAIR:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = database:get(bot_id.."ZORBAIR:Add:Rd:Manager:Photo"..text..msg.chat_id_)
local video = database:get(bot_id.."ZORBAIR:Add:Rd:Manager:Video"..text..msg.chat_id_)
local document = database:get(bot_id.."ZORBAIR:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = database:get(bot_id.."ZORBAIR:Add:Rd:Manager:Audio"..text..msg.chat_id_)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = database:get(bot_id..'ZORBAIR:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'ZORBAIR:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
send(msg.chat_id_, msg.id_, Text)
database:sadd(bot_id.."ZORBAIR:Spam:Group"..msg.sender_user_id_,text) 
end,nil)
end
if stekr then 
...
if text == 'السيرفر' and DevZORBAIR(msg) then 
...
------------------------------------------------------------------------
if text == ("مسح الردود العامه") and DevZORBAIR(msg) then 
local list = database:smembers(bot_id.."ZORBAIR:List:Rd:Sudo")
for k,v in pairs(list) do
database:del(bot_id.."ZORBAIR:Add:Rd:Sudo:Gif"..v)   
database:del(bot_id.."ZORBAIR:Add:Rd:Sudo:vico"..v)   
database:del(bot_id.."ZORBAIR:Add:Rd:Sudo:stekr"..v)     
database:del(bot_id.."ZORBAIR:Add:Rd:Sudo:Text"..v)   
database:del(bot_id.."ZORBAIR:Add:Rd:Sudo:Photo"..v)
database:del(bot_id.."ZORBAIR:Add:Rd:Sudo:Video"..v)
database:del(bot_id.."ZORBAIR:Add:Rd:Sudo:File"..v)
database:del(bot_id.."ZORBAIR:Add:Rd:Sudo:Audio"..v)
database:del(bot_id.."ZORBAIR:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"๛ تم مسح الردود العامه")
end
if text == ("الردود العامه") and DevZORBAIR(msg) then 
local list = database:smembers(bot_id.."ZORBAIR:List:Rd:Sudo")
text = "\nᯓ قائمة الردود العامه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if database:get(bot_id.."ZORBAIR:Add:Rd:Sudo:Gif"..v) then
db = "متحركه ๛"
elseif database:get(bot_id.."ZORBAIR:Add:Rd:Sudo:vico"..v) then
db = "بصمه ๛"
elseif database:get(bot_id.."ZORBAIR:Add:Rd:Sudo:stekr"..v) then
db = "ملصق ๛"
elseif database:get(bot_id.."ZORBAIR:Add:Rd:Sudo:Text"..v) then
db = "رساله ๛"
elseif database:get(bot_id.."ZORBAIR:Add:Rd:Sudo:Photo"..v) then
db = "صوره ๛"
elseif database:get(bot_id.."ZORBAIR:Add:Rd:Sudo:Video"..v) then
db = "فيديو ๛"
elseif database:get(bot_id.."ZORBAIR:Add:Rd:Sudo:File"..v) then
db = "ملف ๛"
elseif database:get(bot_id.."ZORBAIR:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه ๛"
end
text = text..""..k.." >> ("..v..") » {"..db.."}\n"
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."ZORBAIR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."ZORBAIR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."ZORBAIR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."ZORBAIR:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."ZORBAIR:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."ZORBAIR:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."ZORBAIR:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."ZORBAIR:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."ZORBAIR:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."ZORBAIR:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
database:set(bot_id.."ZORBAIR:Add:Rd:Sudo:Photo"..test, photo_in_group)  
end
send(msg.chat_id_, msg.id_,"๛ تم حفظ الرد بنجاح")
return false  
end  
...
if text == "اضف رد عام" and DevZORBAIR(msg) then 
send(msg.chat_id_, msg.id_,"๛ ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."ZORBAIR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد عام" and DevZORBAIR(msg) then 
send(msg.chat_id_, msg.id_,"๛ ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."ZORBAIR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."ZORBAIR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '๛ الان ارسل الرد الذي تريد اضافته \nᯓ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\nᯓ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."ZORBAIR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."ZORBAIR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."ZORBAIR:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."ZORBAIR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"๛ تم ازالة الرد من قائمه الردود العامه")
list = {"Add:Rd:Sudo:Audio","Add:Rd:Sudo:File","Add:Rd:Sudo:Video","Add:Rd:Sudo:Photo","Add:Rd:Sudo:Text","Add:Rd:Sudo:stekr","Add:Rd:Sudo:vico","Add:Rd:Sudo:Gif"}
for k,v in pairs(list) do
database:del(bot_id..'ZORBAIR:'..v..text)
end
database:del(bot_id.."ZORBAIR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."ZORBAIR:List:Rd:Sudo", text)
return false
end
end
----------
...
if text == ("مسح الردود المتعدده") and DevZORBAIR(msg) then
...
------------
if text == ("الردود المتعدده") and DevZORBAIR(msg) then
local list = database:smembers(bot_id.."botss:DRAGON:List:Rd:Sudo")
text = "\nقائمة ردود المتعدده \nٴ≪┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do
db = "رساله "
...
if text == "اضف رد متعدد" and DevZORBAIR(msg) then
...
if text == "حذف رد متعدد" and DevZORBAIR(msg) then
...
if text and not database:get(bot_id.."ZORBAIR:Reply:Sudo"..msg.chat_id_) then
if not database:sismember(bot_id..'ZORBAIR:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."ZORBAIR:Add:Rd:Sudo:Gif"..text)   
local veico = database:get(bot_id.."ZORBAIR:Add:Rd:Sudo:vico"..text)   
local stekr = database:get(bot_id.."ZORBAIR:Add:Rd:Sudo:stekr"..text)     
local Text = database:get(bot_id.."ZORBAIR:Add:Rd:Sudo:Text"..text)   
local photo = database:get(bot_id.."ZORBAIR:Add:Rd:Sudo:Photo"..text)
local video = database:get(bot_id.."ZORBAIR:Add:Rd:Sudo:Video"..text)
local document = database:get(bot_id.."ZORBAIR:Add:Rd:Sudo:File"..text)
local audio = database:get(bot_id.."ZORBAIR:Add:Rd:Sudo:Audio"..text)
...
if database:sismember(bot_id.."ZORBAIR:Sudo:User",result.id_) then
dev = "المطور ،" else dev = "" end
if database:sismember(bot_id.."ZORBAIR:Basic:Constructor"..msg.chat_id_, result.id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."ZORBAIR:Constructor"..msg.chat_id_, result.id_) then
cr = "منشئ ،" else cr = "" end
if database:sismember(bot_id.."ZORBAIR:Manager"..msg.chat_id_, result.id_) then
own = "مدير ،" else own = "" end
if database:sismember(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_, result.id_) then
mod = "ادمن ،" else mod = "" end
if database:sismember(bot_id.."ZORBAIR:Special:User"..msg.chat_id_, result.id_) then
vip = "مميز ،" else vip = ""
end
if Rank_Checking(result.id_,msg.chat_id_) ~= false then
send(msg.chat_id_, msg.id_,"\nᯓ تم تنزيل الشخص من الرتب التاليه \nᯓ { "..dev..""..crr..""..cr..""..own..""..mod..""..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\nᯓ ليس لديه رتب حتى استطيع تنزيله \n")
end
...
database:srem(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."ZORBAIR:Special:User"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."ZORBAIR:Sudo:User",msg.sender_user_id_) then
database:srem(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."ZORBAIR:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."ZORBAIR:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."ZORBAIR:Constructor"..msg.chat_id_, result.id_)
database:srem(bot_id.."ZORBAIR:Basic:Constructor"..msg.chat_id_,result.id_)
elseif database:sismember(bot_id.."ZORBAIR:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."ZORBAIR:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."ZORBAIR:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."ZORBAIR:Constructor"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."ZORBAIR:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."ZORBAIR:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."ZORBAIR:Manager"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."ZORBAIR:Manager"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."ZORBAIR:Special:User"..msg.chat_id_, result.id_)
end
else
...
if database:sismember(bot_id.."ZORBAIR:Sudo:User",result.sender_user_id_) then
dev = "المطور ،" else dev = "" end
if database:sismember(bot_id.."ZORBAIR:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."ZORBAIR:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = "منشئ ،" else cr = "" end
if database:sismember(bot_id.."ZORBAIR:Manager"..msg.chat_id_, result.sender_user_id_) then
own = "مدير ،" else own = "" end
if database:sismember(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = "ادمن ،" else mod = "" end
if database:sismember(bot_id.."ZORBAIR:Special:User"..msg.chat_id_, result.sender_user_id_) then
vip = "مميز ،" else vip = ""
end
...
for k, v in pairs(list) do
x = x + 1
if database:get(bot_id.."ZORBAIR:User:Name"..v.user_id_) then
t = t..""..x.." - {[@"..database:get(bot_id.."ZORBAIR:User:Name"..v.user_id_).."]}\n"
else
t = t..""..x.." - {"..v.user_id_.."}\n"
end
end
...
if text == "رتبتي" then
local rtp = database:get(bot_id.."ZORBAIR:Comd:New:rt:User:"..msg.chat_id_..msg.sender_user_id_) or Get_Rank(msg.sender_user_id_,msg.chat_id_)
...
"\n\nᯓ عدد المطرودين : "..data.kicked_count_..
"\n\nᯓ عدد الاعضاء : "..data.member_count_..
"\n\nᯓ عدد رسائل الجروب : "..(msg.id_/2097152/0.5)..
"\n\nᯓ اسم المجموعه : ["..ta.title_.."]"
send(msg.chat_id_, msg.id_, taha) 
end,nil)
end,nil)
end 
if text == "اطردني" or text == "طردني" then
if not database:get(bot_id.."ZORBAIR:Kick:Me"..msg.chat_id_) then
if Rank_Checking(msg.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, "\nᯓ عذرا لا استطيع طرد ( "..Get_Rank(msg.sender_user_id_,msg.chat_id_).." )")
return false
end
...
database:del(bot_id..'ZORBAIR:Lock:Added:Me'..msg.chat_id_)  
send(msg.id_,'๛ تم تفعيل امر منو ضافني') 
return false
end
if text == 'تعطيل مين ضافني' and Owner(msg) then  
database:set(bot_id..'ZORBAIR:Lock:Added:Me'..msg.chat_id_,true)  
send(msg.chat_id_, msg.id_,'๛ تم تعطيل امر مين ضافني') 
return false
end

if text and text:match("(.*)(مين ضافني)(.*)") then
if not database:get(bot_id..'ZORBAIR:Lock:Added:Me'..msg.chat_id_) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da and da.status_.ID == "ChatMemberStatusCreator" then
send(msg.chat_id_, msg.id_,'๛ انت منشئ المجموعه ') 
return false
end
local Added_Me = database:get(bot_id.."ZORBAIR:Who:Added:Me"..msg.chat_id_..':'..msg.sender_user_id_)
if Added_Me then 
...
database:del(bot_id.."ZORBAIR:Kick:Me"..msg.chat_id_)  
Text = "\nᯓ تم تفعيل امر اطردني"
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تعطيل اطردني" and Owner(msg) then  
database:set(bot_id.."ZORBAIR:Kick:Me"..msg.chat_id_,true)  
Text = "\nᯓ تم تعطيل امر اطردني"
send(msg.chat_id_, msg.id_,Text) 
end
...
function Function_ZORBAIR(extra, result, success)
if result.id_ then
if DevZORBAIR(msg) then
database:srem(bot_id.."ZORBAIR:GBan:User",result.id_)
database:srem(bot_id.."ZORBAIR:Ban:User"..msg.chat_id_,result.id_)
database:srem(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,result.id_)
usertext = "\nᯓ العضو » ["..result.title_.."](t.me/"..(username or "kenwa")..")"
status  = "\nᯓ تم الغاء القيود عنه"
...
database:srem(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = "\nᯓ العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "kenwa")..")"
status  = "\nᯓ تم الغاء القيود عنه"
...
function Function_ZORBAIR(extra, result, success)
if result.id_ then
if database:sismember(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."ZORBAIR:Ban:User"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."ZORBAIR:GBan:User",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
function Function_ZORBAIR(extra, result, success)
if database:sismember(bot_id.."ZORBAIR:Muted:User"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."ZORBAIR:Ban:User"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."ZORBAIR:GBan:User",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
database:sadd(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_, admins[i].user_id_)
nu2 = nu2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
database:srem(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
database:srem(bot_id.."ZORBAIR:Mod:User"..msg.chat_id_, admins[i].user_id_)
...
-------
if text == ("رفع مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and DevZORBAIR(msg) then
...
if text and text:match("^رفع مطور ثانوي @(.*)$") and DevZORBAIR(msg) then
...
if text and text:match("^رفع مطور ثانوي (%d+)$") and DevZORBAIR(msg) then
...
if text == ("تنزيل مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and DevZORBAIR(msg) then
function Function_BOYKA(extra, result, success)
...
if text and text:match("^تنزيل مطور ثانوي @(.*)$") and DevZORBAIR(msg) then
...
if text and text:match("^تنزيل مطور ثانوي (%d+)$") and DevZORBAIR(msg) then
...
if text == ("الثانويين") and DevZORBAIR(msg) then
local list = database:smembers(bot_id.."DEV:Sudo:T")
t = "\nᯓ قائمة مطورين الثانويين للبوت \n ╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."ZORBAIR:User:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if text == ("مسح الثانويين") and DevZORBAIR(msg) then
database:del(bot_id.."DEV:Sudo:T")
send(msg.chat_id_, msg.id_, "\nᯓ تم مسح قائمة المطورين الثانويين  ")
end
-------
if text ==("المنشئ") then
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data) 
...
database:sadd(bot_id.."ZORBAIR:Basic:Constructor"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
end

if text == "غادر" then 
if DevBot(msg) and not database:get(bot_id.."ZORBAIR:Left:Bot"..msg.chat_id_) then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,"๛ تم مغادرة المجموعه") 
database:srem(bot_id.."ZORBAIR:Chek:Groups",msg.chat_id_)  
end
return false  
end
...
database:srem(bot_id.."ZORBAIR:Chek:Groups",GP_ID[2])  
return false 
end
end
if text == "تفعيل المغادره" and DevZORBAIR(msg) then   
database:del(bot_id.."ZORBAIR:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"๛ تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and DevZORBAIR(msg) then  
database:set(bot_id.."ZORBAIR:Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "๛ تم تعطيل مغادرة البوت") 
return false 
end
if text == (database:get(bot_id.."ZORBAIR:Name:Bot") or "زورو") then
Namebot = (database:get(bot_id.."ZORBAIR:Name:Bot") or "زورو")
local namebot = {
'๛ يوه '..Namebot..' زهق منك😒',
'๛ نعم ياعيون '..Namebot..' 😻💓',
'๛ عايز اي من '..Namebot..' 🙄💛',
...
print("it is Bot")
N = (database:get(bot_id.."Tshake:Name:Bot") or "زورو")
...
if DevZORBAIR(msg) then
database:setex(bot_id.."ZORBAIR:Set:Name:Bot"..msg.sender_user_id_,300,true) 
...
if database:get(bot_id.."ZORBAIR:Status:Bc") and not DevBOYKAW(msg) then 
send(msg.chat_id_, msg.id_,"๛ الاذاعه معطله من قبل المطور الاساسي")
return false
end
database:setex(bot_id.."ZORBAIR:ZORBAIR:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."ZORBAIR:ZORBAIR:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"๛ ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\nᯓ للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."ZORBAIR:ZORBAIR:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"๛ ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\nᯓ للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."ZORBAIR:ZORBAIR:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."ZORBAIR:ZORBAIR:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"๛ ارسل لي التوجيه الان") 
return false
end 

if text == "تفعيل الاذاعه" and DevBOYKAW(msg) then  
database:del(bot_id.."ZORBAIR:Status:Bc") 
send(msg.chat_id_, msg.id_,"\nᯓ تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and DevBOYKAW(msg) then  
database:set(bot_id.."ZORBAIR:Status:Bc",true) 
send(msg.chat_id_, msg.id_,"\nᯓ تم تعطيل الاذاعه") 
return false
end 

if text == "الاعدادات" and Addictive(msg) then    
if database:get(bot_id.."ZORBAIR:lockpin"..msg.chat_id_) then    
lock_pin = "✓"
else 
lock_pin = "✘"    
end
if database:get(bot_id.."ZORBAIR:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✘"    
end
if database:get(bot_id.."ZORBAIR:Lock:text"..msg.chat_id_) then    
lock_text = "✓"
else 
lock_text = "✘"    
end
...
if database:get(bot_id.."ZORBAIR:Lock:edit"..msg.chat_id_) then    
lock_edit = "✓"
else 
lock_edit = "✘"    
end
...
if database:hget(bot_id.."ZORBAIR:flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = "بالطرد"     
elseif database:hget(bot_id.."ZORBAIR:flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = "بالتقييد"     
elseif database:hget(bot_id.."ZORBAIR:flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = "بالكتم"           
elseif database:hget(bot_id.."ZORBAIR:flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = "بالمسح"           
else     
flood = "✘"     
end
...
if database:get(bot_id.."ZORBAIR:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "✓"
elseif database:get(bot_id.."ZORBAIR:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "بالتقييد"    
elseif database:get(bot_id.."ZORBAIR:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "بالكتم"    
elseif database:get(bot_id.."ZORBAIR:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "بالطرد"    
else
lock_links = "✘"    
end
if database:get(bot_id.."ZORBAIR:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "✓"
elseif database:get(bot_id.."ZORBAIR:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "بالتقييد"    
elseif database:get(bot_id.."ZORBAIR:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "بالكتم"   
elseif database:get(bot_id.."ZORBAIR:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "بالطرد"    
else
lock_cmds = "✘"    
end
if database:get(bot_id.."ZORBAIR:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "✓"
elseif database:get(bot_id.."ZORBAIR:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "بالتقييد"    
elseif database:get(bot_id.."ZORBAIR:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "بالكتم"    
elseif database:get(bot_id.."ZORBAIR:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "بالطرد"    
else
lock_user = "✘"    
end
if database:get(bot_id.."ZORBAIR:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "✓"
elseif database:get(bot_id.."ZORBAIR:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "بالتقييد"    
elseif database:get(bot_id.."ZORBAIR:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "بالكتم"    
elseif database:get(bot_id.."ZORBAIR:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "بالطرد"    
else
lock_hash = "✘"    
end
...
if database:get(bot_id.."ZORBAIR:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "✓"
elseif database:get(bot_id.."ZORBAIR:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "بالتقييد"   
elseif database:get(bot_id.."ZORBAIR:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "✘"    
end
...
if database:get(bot_id.."ZORBAIR:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "✓"
elseif database:get(bot_id.."ZORBAIR:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "بالتقييد"    
elseif database:get(bot_id.."ZORBAIR:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "بالكتم"    
elseif database:get(bot_id.."ZORBAIR:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "بالطرد"    
else
lock_spam = "✘"    
end        
if not database:get(bot_id.."ZORBAIR:Reply:Manager"..msg.chat_id_) then
rdmder = "✓"
else
rdmder = "✘"
end
if not database:get(bot_id.."ZORBAIR:Reply:Sudo"..msg.chat_id_) then
rdsudo = "✓"
else
rdsudo = "✘"
end
if not database:get(bot_id.."ZORBAIR:Lock:ID:Bot"..msg.chat_id_)  then
idgp = "✓"
else
idgp = "✘"
end
if not database:get(bot_id.."ZORBAIR:Lock:ID:Bot:Photo"..msg.chat_id_) then
idph = "✓"
else
idph = "✘"
end
if not database:get(bot_id.."ZORBAIR:Lock:kick"..msg.chat_id_)  then
setadd = "✓"
else
setadd = "✘"
end
if not database:get(bot_id.."ZORBAIR:Lock:Add:Bot"..msg.chat_id_)  then
banm = "✓"
else
banm = "✘"
end
...
Num_Flood = database:hget(bot_id.."ZORBAIR:flooding:settings:"..msg.chat_id_,"floodmax") or 0
local text = 
"*\nᯓ ااعدادات المجموعه "..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ "..
"\nᯓ علامة ال {✓} تعني مفعل"..
"\nᯓ علامة ال {✘} تعني معطل"..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ "..
"\nᯓ الروابط » "..lock_links..
"\n".."๛ المعرفات » "..lock_user..
"\n".."๛ التاك » "..lock_hash..
"\n".."๛ البوتات » "..lock_bots..
"\n".."๛ التوجيه » "..lock_fwd..
...
database:setex(bot_id.."ZORBAIR:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
local Text= [[
๛ ارسل الان النص
๛ يمكنك اضافه :
- `#username` > اسم المستخدم
...
if Owner(msg) then
database:del(bot_id.."ZORBAIR:Klesh:Id:Bot"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '๛ تم ازالة كليشة الايدي ')
end
return false  
end 

if database:get(bot_id.."ZORBAIR:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"๛ تم الغاء تعين الايدي") 
database:del(bot_id.."ZORBAIR:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."ZORBAIR:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
database:set(bot_id.."ZORBAIR:Klesh:Id:Bot"..msg.chat_id_,text:match("(.*)"))
send(msg.chat_id_, msg.id_,'๛ تم تعين الايدي')    
end

if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'ZORBAIR:Lock:ID:Bot'..msg.chat_id_) then
if not database:sismember(bot_id..'ZORBAIR:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."ZORBAIR:Spam:Group"..msg.sender_user_id_,text) 
...
local Add_Mem = database:get(bot_id.."ZORBAIR:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local get_id = database:get(bot_id.."ZORBAIR:Klesh:Id:Bot"..msg.chat_id_)
if not database:get(bot_id..'ZORBAIR:Lock:ID:Bot:Photo'..msg.chat_id_) then
if taha.photos_[0] then
if get_id then
...
if text == 'صورتي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'ZORBAIR:Lock:ID:Bot'..msg.chat_id_) then
if not database:sismember(bot_id..'ZORBAIR:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."ZORBAIR:Spam:Group"..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,taha,success) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
local NumMsg = database:get(bot_id..'ZORBAIR:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."ZORBAIR:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'ZORBAIR:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Num_Games = database:get(bot_id.."Tshak:Add:Num"..msg.chat_id_..msg.sender_user_id_) or 0
local Add_Mem = database:get(bot_id.."ZORBAIR:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
local Total_Photp = (taha.total_count_ or 0)
...
local Id = data.id_
local NumMsg = database:get(bot_id..'ZORBAIR:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."ZORBAIR:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'ZORBAIR:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."Tshak:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."ZORBAIR:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
send(msg.chat_id_, msg.id_,'*๛ ايديه - '..Id..'\nᯓ رسائله - '..NumMsg..'\nᯓ معرفه - *['..UserName_User..']*\nᯓ تفاعله - '..TotalMsg..'\nᯓ رتبته - '..Status_Gps..'\nᯓ تعديلاته - '..message_edit..'\nᯓ جهاته - '..Add_Mem..'*') 
end,nil)   
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ZORBAIR, nil)
return false
...
if text and text:match("^ايدي @(.*)$") and not database:get(bot_id..'ZORBAIR:Lock:ID:Bot'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_,"๛ الف مبروك لقد فزت \nᯓ للعب مره اخره ارسل ~{ الاسرع , ترتيب }")
database:incrby(bot_id.."Tshak:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
database:del(bot_id.."Tshak:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."Tshak:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,"๛ اوبس لقد خسرت في اللعبه \nᯓ حظآ اوفر في المره القادمه \nᯓ كان الرقم الذي تم تخمينه { "..GETNUM.." }")
else
send(msg.chat_id_, msg.id_,"๛ اوبس تخمينك غلط \nᯓ ارسل رقم تخمنه مره اخرى ")
end
end
end
end
...
send(msg.chat_id_, msg.id_,"\nᯓ اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n".."๛ ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n".."๛ سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ")
...
๛ بضغط ع الزر بلاسفل ..🎮
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
๛ CH - [⦖ ⤾ 𝒁𝑶𝑹𝑶 𝑷𝑳𝑼𝑺 ⤿ ⦕](t.me/SOURCE_ZORO_plus) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'رسائلي' then
local nummsg = database:get(bot_id..'ZORBAIR:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 1
local Text = '๛ عدد رسائلك هنا *~ '..nummsg..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح رسائلي' then
database:del(bot_id..'ZORBAIR:messageUser'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '๛ تم مسح جميع رسائلك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'سحكاتي' or text == 'تعديلاتي' then
local edit = database:get(bot_id..'ZORBAIR:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Text = '๛ عدد التعديلات هنا *~ '..edit..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
database:del(bot_id..'ZORBAIR:message_edit'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '๛ تم مسح جميع تعديلاتك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'جهاتي' then
local addmem = database:get(bot_id.."ZORBAIR:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
local Text = '๛ عدد جهاتك المضافه هنا *~ '..addmem..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح جهاتي' then
database:del(bot_id..'ZORBAIR:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
...
database:incrby(bot_id.."ZORBAIR:messageUser"..msg.chat_id_..":"..iduserr,numadded)  
...
database:incrby(bot_id.."ZORBAIR:messageUser"..msg.chat_id_..":"..result.sender_user_id_,Num)  
send(msg.chat_id_, msg.id_, "\nᯓ تم اضافة له {"..Num.."} من الرسائل")  
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},reply, nil)
return false
end

if text == "مسح المشتركين" and DevZORBAIR(msg) then
local pv = database:smembers(bot_id..'ZORBAIR:UsersBot')  
local sendok = 0
for i = 1, #pv do
...
database:srem(bot_id..'ZORBAIR:UsersBot',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'*๛ عدد المشتركين الان ~ '..#pv..'\nᯓ تم العثور على ~ '..sendok..' مشترك قام بحظر البوت\nᯓ اصبح عدد المشتركين الان ~ '..ok..' مشترك *')   
end
end
end,nil)
end,nil)
...
if text == "مسح الجروبات" and DevZORBAIR(msg) then
local group = database:smembers(bot_id..'ZORBAIR:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
...
database:srem(bot_id..'ZORBAIR:Chek:Groups',group[i])  
w = w + 1
end
...
taha = '\nᯓ تم ازالة ~ '..q..' مجموعات من البوت'
end
if w == 0 then
storm = ''
else
storm = '\nᯓ تم ازالة ~'..w..' مجموعه لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'*๛ عدد المجموعات الان ~ '..#group..' مجموعه '..storm..''..taha..'\nᯓ اصبح عدد المجموعات الان ~ '..sendok..' مجموعات*\n')   
end
end
end,nil)
end
...
if text == ("تحديث السورس") and DevZORBAIR(msg) then  
send(msg.chat_id_,msg.id_,'๛ تم التحديث')
os.execute('rm -rf ZORBAIR.lua')
os.execute('rm -rf start.lua')
download_to_file('https://raw.githubusercontent.com/jokerrrrrrrrrr7/ZO7/main/ZORO.lua', 'ZORBAIR.lua') 
download_to_file('https://raw.githubusercontent.com/jokerrrrrrrrrr7/ZO7/main/start.lua', 'start.lua') 
dofile('ZORBAIR.lua')  
return false
end


if text == 'تفعيل البوت الخدمي' and DevZORBAIR(msg) then  
database:del(bot_id..'ZORBAIR:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'๛ تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي' and DevZORBAIR(msg) then  
database:set(bot_id..'ZORBAIR:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'๛ تم تعطيل البوت الخدمي') 
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevZORBAIR(msg) then
local Num = text:match("تعين عدد الاعضاء (%d+)$") 
database:set(bot_id..'ZORBAIR:Num:Add:Bot',Num) 
send(msg.chat_id_, msg.id_,'๛ تم وضع عدد الاعضاء *~'..Num..'* عضو')
end
if text =='الاحصائيات' and DevBot(msg) then
local Groups = database:scard(bot_id..'ZORBAIR:Chek:Groups')  
local Users = database:scard(bot_id..'ZORBAIR:UsersBot')  
send(msg.chat_id_, msg.id_,'๛ احصائيات البوت \n\nᯓ عدد المجموعات *~ '..Groups..'\nᯓ عدد المشتركين ~ '..Users..'*')
end
if text == 'جلب نسخه احتياطيه' and DevZORBAIR(msg) then
local list = database:smembers(bot_id..'ZORBAIR:Chek:Groups')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'ZORBAIR Chat'
ASAS = database:smembers(bot_id.."ZORBAIR:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."ZORBAIR:Constructor"..v)
MDER = database:smembers(bot_id.."ZORBAIR:Manager"..v)
MOD = database:smembers(bot_id.."ZORBAIR:Mod:User"..v)
link = database:get(bot_id.."ZORBAIR:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"ZORBAIR":"'..NAME..'",'
else
t = t..',"'..v..'":{"ZORBAIR":"'..NAME..'",'
...
t = t..'}}'
local File = io.open('./ZOR/'..bot_id..'.json', "w")
File:write(t)
File:close()
sendDocument(msg.chat_id_, msg.id_,'./ZOR/'..bot_id..'.json', '๛ عدد مجموعات التي في البوت { '..#list..'}')
end
...
if text == 'الملفات' and DevZORBAIR(msg) then
t = '๛ جميع الملفات : \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n'
i = 0
for v in io.popen('ls ZORBAIR_Files'):lines() do
if v:match(".lua$") then
...
if Get_info then
local TextS = "\nᯓ اهلا بك في متجر ملفات زورو \nᯓ الملفات الموجوده حاليا \nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n\n"
local TextE = "\nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\nᯓ تدل علامة (✔) الملف مفعل\n".."๛ تدل علامة (๛) الملف معطل\n"
local NumFile = 0
for name,Info in pairs(res.plugins_) do
local Check_File_is_Found = io.open("ZORBAIR_Files/"..name,"r")
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevZORBAIR(msg) then
local name_t = {string.match(text, "^(تعطيل ملف) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("ZORBAIR_Files/"..file,"r")
if file_bot then
io.close(file_bot)
t = "*๛ الملف » {"..file.."}\nᯓ تم تعطيله وحذفه بنجاح \n✓*"
else
t = "*๛ بالتاكيد تم تعطيل وحذف ملف » {"..file.."} \n✓*"
end
local json_file, res = https.request("https://raw.githubusercontent.com/jaxso0n/jaxson/master/files_ZORBAIR/"..file)
if res == 200 then
os.execute("rm -fr ZORBAIR_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('SOURCE_ZORO_plus.lua')  
else
send(msg.chat_id_, msg.id_,"*๛ عذرا لا يوجد هاكذا ملف في المتجر *\n") 
end
return false
end
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevZORBAIR(msg) then
...
t = "*๛ الملف » {"..file.."}\nᯓ تم تنزيله وتفعيله بنجاح \nᯓ*"
end
local json_file, res = https.request("https://raw.githubusercontent.com/jaxso0n/jaxson/master/files_ZORBAIR/"..file)
if res == 200 then
local chek = io.open("ZORBAIR_Files/"..file,'w+')
...
if text == "مسح جميع الملفات" and DevZORBAIR(msg) then
os.execute("rm -fr ZORBAIR_Files/*")
send(msg.chat_id_,msg.id_,"๛ تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and DevZORBAIR(msg) then
local Users = database:smembers('ZORBAIR:'..bot_id.."userss")
local Groups = database:smembers('ZORBAIR:'..bot_id..'groups') 
for i = 1, #Groups do
database:sadd(bot_id..'ZORBAIR:Chek:Groups',Groups[i])  
local list1 = database:smembers('ZORBAIR:'..bot_id..'creatorbasic:'..Groups[i])
for k,v in pairs(list1) do
database:sadd(bot_id.."ZORBAIR:Basic:Constructor"..Groups[i], v)
end
local list2 = database:smembers('ZORBAIR:'..bot_id..'creator:'..Groups[i])
for k,v in pairs(list2) do
database:sadd(bot_id.."ZORBAIR:Constructor"..Groups[i], v)
end
local list3 = database:smembers('ZORBAIR:'..bot_id..'owners:'..Groups[i])
for k,v in pairs(list3) do
database:sadd(bot_id.."ZORBAIR:Manager"..Groups[i], v)
end
local list4 = database:smembers('ZORBAIR:'..bot_id..'mods:'..Groups[i])
for k,v in pairs(list4) do
database:sadd(bot_id.."ZORBAIR:Mod:User"..Groups[i], v)
end
database:set(bot_id.."ZORBAIR:Lock:tagservrbot"..Groups[i],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'ZORBAIR:'..lock..Groups[i],"del")    
end
end
for i = 1, #Users do
database:sadd(bot_id..'ZORBAIR:UsersBot',Users[i])  
end
send(msg.chat_id_, msg.id_,'๛ تم نقل : '..#Groups..' كروب\nᯓ تم نقل : '..#Users..' مشترك \nᯓ من التحديث القديم الى التحديث الجديد')
end
if text == 'حذف كليشه المطور' and DevZORBAIR(msg) then
database:del(bot_id..'ZORBAIR:Text_Dev')
send(msg.chat_id_, msg.id_,'๛ تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevZORBAIR(msg) then
database:set(bot_id..'ZORBAIR:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'๛ ارسل الكليشه الان')
return false
end
if text and database:get(bot_id..'ZORBAIR:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' then 
database:del(bot_id..'ZORBAIR:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'๛ تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'ZORBAIR:Text_Dev',text)
database:del(bot_id..'ZORBAIR:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'๛ تم حفظ كليشة المطور')
return false
end
if text == 'رفع النسخه الاحتياطيه' and DevZORBAIR(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and DevZORBAIR(msg) then
dofile("ZORBAIR.lua")  
send(msg.chat_id_, msg.id_, "๛ تم التحديث")
end
-----Zhrfa--------
...
send(msg.chat_id_, msg.id_, t..'⦖ ⤾ 𝒁𝑶𝑹𝑶 𝑷𝑳𝑼𝑺 ⤿ ⦕\nᯓ CH - [⦖ ⤾ 𝒁𝑶𝑹𝑶 𝑷𝑳𝑼𝑺 ⤿ ⦕](t.me/SOURCE_ZORO_plus)  ')
end
...
keyboard.inline_keyboard = {
{
{text = 'ᯓ 𓆩 ˹⋆َᴀ.ʙᴀʜَᴊᴀْᴛ ˼ 𓆪 𓆃', url = "https://t.me/Bahjat100"}
},
{
{text = 'ᴄʜᴀɴɴᴇʟ', url = "https://t.me/joinchat/g-ydeDBrho4xNmE0"}
},
{
{text = '๛ M𝚈 𝙲𝙷𝙰𝙽𝙽𝙴𝙻𝚂', url = "https://t.me/SOURCE_ZORO_plus"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SOURCE_ZORO_plus&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
------------
if text == 'جوكر' or text == 'مجمد' or text == 'الجوكر' or text == '"' then
local Text =[[
๛ جوكر يمكنك التواصل معه 
...
{
{text = '𝗗𝗘𝗩 𝗝𝗢𝗞𝗘𝗥', url = "https://t.me/UUOUOU_7"}
},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'بهجت' or text == 'عبدالله بهجت' or text == 'bahjat' or text == '"' then
local Text =[[
ᴘʀᴏɢʀᴀᴍᴍᴇʀ ѕᴏụʀᴄᴇ ᴢᴏʀᴏ ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {

{
{text = 'ʙᴀʜᴊᴀᴛ', url = "https://t.me/Bahjat100"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Bahjat100&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == ' تواصل ' or text == ' بوت التواصل ' or text == ' التواصل ' or text == '"' then
local Text =[[
๛ بوت تواصل سورس زورو ↓
]]
keyboard = {} 
...
{
{text = 'ᴛᴡᴀ', url = "https://t.me/T_A_Bll_bot"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/T_A_Bll_bot&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تابع جديدنا من فضلك ',url="t.me/SOURCE_ZORO_plus"}}, 
{{text = 'لشراء نسخة من البوت ',url="t.me/UUOUOU_7"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
----------
if not database:get(bot_id..'ZORBAIR:Reply:Mute'..msg.chat_id_) then
if text == 'هلو' then
...
database:del(bot_id..'ZORBAIR:Reply:Mute'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'๛ تم تفعيل الردود')
return false
end

if text == 'تعطيل ردود السورس' and Owner(msg) then
database:set(bot_id..'ZORBAIR:Reply:Mute'..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,'๛ تم تعطيل الردود')
return false
end
----------
...
彡 .[SOURCE ZORBAIR ๛](t.me/SOURCE_ZORO_plus)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'ZORBAIR:Num:Add:Bot') or 0) and not DevZORBAIR(msg) then
send(msg.chat_id_, msg.id_,'๛ عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'ZORBAIR:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'ZORBAIR:Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'๛ المجموعه مفعله سابقا ')
else
Reply_Status(msg,result.id_,'reply_Add','๛ تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'ZORBAIR:Chek:Groups',msg.chat_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
...
'\nᯓ بواسطة ~ '..Name..''..
'\nᯓ ايدي المجموعه ~ `'..IdChat..'`'..
'\nᯓ عدد اعضاء المجموعه *~ '..NumMember..'*'..
'\nᯓ اسم المجموعه ~ ['..NameChat..']'..
'\nᯓ الرابط ~ ['..LinkGp..']'
if not DevZORBAIR(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if not database:sismember(bot_id..'ZORBAIR:Chek:Groups',msg.chat_id_) then
...
database:set(bot_id.."ZORBAIR:Private:Group:Link"..msg.chat_id_,LinkGp) 
...
if text == 'تفعيل' and not DevBot(msg) and not database:get(bot_id..'ZORBAIR:Free:Add:Bots') then 
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'๛ البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
...
Reply_Status(msg,result.id_,'reply_Add','๛ تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'ZORBAIR:Chek:Groups',msg.chat_id_)  
database:sadd(bot_id..'ZORBAIR:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if not database:get(bot_id..'ZORBAIR:Start:Time'..msg.sender_user_id_) then
local start = database:get(bot_id.."Start:Bot")  
if start then 
Test = start
else
Test = '๛ مرحبا انا بوت حماية كروبات\nᯓ وضيفتي حماية المجموعات من السبام والتفليش والخ...\nᯓ لتفعيل البوت اضفني الى مجموعاتك قم برفعي مشرف ثم ارسل تفعيل \nᯓ معرف المطور ['..UserName..']'
end 
send(msg.chat_id_, msg.id_, Test) 
end
end
database:setex(bot_id..'ZORBAIR:Start:Time'..msg.sender_user_id_,60,true)
return false
end
...
send(msg.chat_id_, msg.id_,'\nᯓ فشل ارسال رسالتك لان العضو قام بحظر البوت') 
return false  
end 
if text then    
...
database:del(bot_id..'ZORBAIR:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'\nᯓ تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي ๛' then
database:set(bot_id..'ZORBAIR:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'\nᯓ تم تعطيل البوت الخدمي') 
end
...
database:del(bot_id.."ZORBAIR:Link_Group"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."ZORBAIR:Chek:Welcome"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."ZORBAIR:Reply:Sudo"..Chat_id,true)   
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id..'ZORBAIR:Lock:ID:Bot'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id..'ZORBAIR:Lock:ID:Bot:Photo'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."ZORBAIR:Kick:Me"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."ZORBAIR:Reply:Manager"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."ZORBAIR:Link_Group"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."ZORBAIR:Chek:Welcome"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."ZORBAIR:Reply:Sudo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id..'ZORBAIR:Lock:ID:Bot'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id..'ZORBAIR:Lock:ID:Bot:Photo'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."ZORBAIR:Kick:Me"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."ZORBAIR:Reply:Manager"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."ZORBAIR:Lock:text"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."ZORBAIR:Lock:Join"..Chat_id,"kick")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."ZORBAIR:Lock:Bot:kick"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."ZORBAIR:Lock:tagservr"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."ZORBAIR:Lock:edit"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."ZORBAIR:Lock:Link"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."ZORBAIR:Lock:User:Name"..Chat_id,"del") 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."ZORBAIR:Lock:hashtak"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."ZORBAIR:Lock:Sticker"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."ZORBAIR:Lock:Animation"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."ZORBAIR:Lock:Video"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."ZORBAIR:Lock:Photo"..Chat_id,"del")    
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."ZORBAIR:Lock:Audio"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."ZORBAIR:Lock:vico"..Chat_id,"del")    
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."ZORBAIR:Lock:forward"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."ZORBAIR:Lock:Document"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."ZORBAIR:Lock:Contact"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."ZORBAIR:Lock:Spam"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:hset(bot_id.."ZORBAIR:flooding:settings:"..Chat_id ,"flood","del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."ZORBAIR:Lock:Inlen"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:AddMempar"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:text"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:Join"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:Bot:kick"..Chat_id)   
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:tagservr"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:edit"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:Link"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:User:Name"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:hashtak"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:Sticker"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:Animation"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:Video"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:Photo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:Audio"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:vico"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:forward"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:Document"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:Contact"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:Spam"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:hdel(bot_id.."ZORBAIR:flooding:settings:"..Chat_id ,"flood")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."ZORBAIR:Lock:Inlen"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ๛', callback_data=data.sender_user_id_.."/homelocks"},
...
database:srem(bot_id..'ZORBAIR:Chek:Groups','-100'..data.channel_.id_)  
end
end
...
database:del(bot_id..'ZORBAIR:nwe:mem:group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'\n تم تعطيل تحقق' ) 
end
if text == 'تفعيل تحقق' and Addictive(msg) then  
database:set(bot_id..'ZORBAIR:nwe:mem:group'..msg.chat_id_,'true') 
send(msg.chat_id_, msg.id_,'\nتم تفعيل تحقق' ) 
end 

if msg.content_.ID == "MessageChatJoinByLink" and database:get(bot_id..'ZORBAIR:nwe:mem:group'..msg.chat_id_) == 'true'then
numphoto = {'3','8','9','6'}
...
if text and not database:sismember(bot_id..'ZORBAIR:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'ZORBAIR:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'ZORBAIR:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."ZORBAIR:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."ZORBAIR:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."ZORBAIR:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."ZORBAIR:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
database:del(bot_id.."ZORBAIR:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
database:del(bot_id.."ZORBAIR:Set:Cmd:Group:New"..msg.chat_id_)
database:srem(bot_id.."ZORBAIR:List:Cmd:Group:New"..msg.chat_id_,text)
...
database:del(bot_id.."ZORBAIR:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
------------------------------------------------------------------------
...
------------------------------------------------------------------------
ZORBAIR_Started_Bot(msg,data)
ZORBAIR_Files(msg)
elseif (data.ID == "UpdateMessageEdited") then
local msg = data
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.message_id_)},function(extra, result, success)
database:incr(bot_id..'ZORBAIR:message_edit'..result.chat_id_..result.sender_user_id_)
local Text = result.content_.text_
if database:get(bot_id.."ZORBAIR:Lock:edit"..msg.chat_id_) and not Text and not BasicConstructor(result) then
...
if database:get(bot_id.."ZORBAIR:Lock:Link"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if database:get(bot_id.."ZORBAIR:Lock:User:Name"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if database:get(bot_id.."ZORBAIR:Lock:hashtak"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
if text and text:match("/") then
if database:get(bot_id.."ZORBAIR:Lock:Cmd"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
------------------------------------------------------------------------
if text then
local ZORBAIR_Msg = database:get(bot_id.."ZORBAIR:Add:Filter:Rp2"..text..result.chat_id_)   
if ZORBAIR_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","๛ "..ZORBAIR_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get(bot_id..'ZORBAIR:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'ZORBAIR:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'ZORBAIR:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
database:srem(bot_id..'ZORBAIR:Chek:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'ZORBAIR:Chek:Groups',v)  
end
...
database:sadd(bot_id..'ZORBAIR:Chek:Groups',v)  
end end,nil)
end;end;end
